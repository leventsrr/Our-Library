...
import 'package:my_library/views/profile_page.dart';
import 'package:my_library/views/sign_in_page.dart';
import 'package:my_library/widgets/book_card_main_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text("What's Read", style: TextStyle(color: Colors.white)),
